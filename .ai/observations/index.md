...
| Chainlink proxy identity and event-emitter identity are distinct | chainlink, proxy, aggregator, AnswerUpdated, AggregatorConfirmed, oracle | high | observation | `chainlink-proxy-vs-aggregator.md` |
